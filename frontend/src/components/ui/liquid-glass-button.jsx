/* eslint-disable react-refresh/only-export-components -- shadcn primitive: exports cva variants alongside the components, same as every components/ui file. */
...
/* Ported to JSX from the shadcn .tsx source (this project is plain JS, no
   TS toolchain). Behaviour and classes are faithful; only type annotations
   were stripped. Fixes over the original paste:
     - export moved below the declarations it names (the original exported
       liquidbuttonVariants/LiquidButton before they existed → TDS crash);
     - `border` variants carry [border-style:solid] since we ship Tailwind
       without Preflight, which is what normally sets it. */
